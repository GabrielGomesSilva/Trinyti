...
2- O campo crm está sendo gravado no campo do telefone. (Corrigido)
3- A consulta pelo crm não está funcionando. (Corrigido)
4- Quando a consulta não traz nenhum dado a tabela está aparecendo "quebrada". (Corrigido)
5- Fazer com que após o cadastro ou alteração o sistema volte para a 1ª aba exibindo os dados atualizado. (Corrigido) 
6- Fazer a rotina de exclusão do registro. (Corrigido)
